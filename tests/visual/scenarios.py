...
PREDEFINED_SCENARIOS: list[VisualScenario] = [
    ...
    VisualScenario(
        ...
        description="System font registry filtered by User Scope.",
        viewport_size=(1280, 820),
    ...
    VisualScenario(
        ...
        description="System font registry view at compact resolution (960x600).",
        viewport_size=(960, 600),
        execute=_scenario_system_view_compact,
    ),
    VisualScenario(
        name="23_system_view_fhd_1920x1080",
        description="System font registry view at Full HD desktop resolution (1920x1080).",
        viewport_size=(1920, 1080),
